<template>
  <div class="bg-white">
          ...
          <div class="flex justify-between min-w-[100vw] items-center bg-white">
            <div class="flex w-full h-full">
              <div class="w-1/2 flex flex-col justify-center px-12">
                ...
                <h2 class="text-3xl md:text-4xl font-light italic text-black mb-4">MOREL</h2>
                <h3 class="text-2xl md:text-3xl font-bold text-black mb-2">ARCHITECTE</h3>
                <h4 class="text-2xl md:text-3xl font-light italic text-black">PHOTOGRAPHER</h4>
              </div>
    ...
    <div
      class="md:hidden h-full overflow-hidden"
      @touchstart="handleTouchStartMobile"
      @touchmove="handleTouchMoveMobile"
      @touchend="handleTouchEndMobile"
      @wheel="handleWheelMobile"
      @contextmenu.prevent
    >
      <div ref="containerMobile" class="transition-transform duration-300 ease-out" :style="{ transform: `translateY(-${scrollPositionMobile}px)` }">
        <div class="h-screen w-full flex flex-col bg-white">
          <div class="h-1/2 flex flex-col justify-center px-8">
            <h1 class="text-4xl font-bold text-black leading-none mb-4">DYLAN</h1>
            <h2 class="text-2xl font-light italic text-black mb-4">MOREL</h2>
            <h3 class="text-xl font-bold text-black mb-2">ARCHITECTE</h3>
            <h4 class="text-xl font-light italic text-black">PHOTOGRAPHE</h4>
          </div>
          <div class="h-1/2 flex items-center justify-center">
