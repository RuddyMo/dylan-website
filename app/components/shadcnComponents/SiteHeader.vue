    ...
    <div class="flex w-full items-center gap-1 px-4 lg:gap-2 lg:px-6">
      ...
      <div class="ml-auto flex items-center gap-2">
        <Button variant="ghost" as-child size="sm" class="hidden sm:flex">
          <a href="https://github.com/shadcn-ui/ui/tree/main/apps/v4/app/(examples)/dashboard" rel="noopener noreferrer" target="_blank" class="dark:text-foreground"> GitHub </a>
        </Button>
      </div>
    </div>
  </header>
